    ...
    <div class="incident-view-container">
      <div class="incident-view-header">
        ...
        <div class="incident-header-actions">
          ...
          <div class="incident-export-controls">
            ...
            <CustomButton
              :config="{
                name: isExporting ? 'Exporting...' : 'Export',
                icon: 'PhDownload',
                className: 'incident-export-btn',
      ...
      <div class="incident-list-wrapper">
        <div class="incident-filter-controls">
          <div class="incident-filter-group" style="width:100%">
            <div style="flex:1;display:flex;align-items:center;gap:16px;width:100%">
              <div style="flex:2">
                <input 
                  type="text" 
                  v-model="searchQuery" 
        ...
        <DynamicTable
          ...
          :defaultPageSize="incidentsPerPage"
          :pageSizeOptions="[10, 20, 50]"
          @page-change="changePage"
          @sort-change="({key, order}) => { sortField = key; sortOrder = order; fetchIncidents(); }"
        >
  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
          { key: 'IncidentId', label: 'ID', sortable: true },
          { 
            key: 'IncidentTitle', 
            label: 'Title', 
            sortable: true,
    ...
    computed: {
      // Remove custom pagination since DynamicTable handles it
    },
    watch: {
      incidents: {
    ...
    beforeUnmount() {
      ...
      exportIncidents() {
        // RBAC Debug - Log user action attempt
        this.logUserAction('EXPORT_INCIDENTS', 'incident', null);
        
        // Check permissions
        if (!this.canViewIncident()) {
          console.warn('❌ Permission denied for export incidents');
          PopupService.error("You don't have permission to export incidents");
          return;
        }
        
        console.log('✅ Permission granted for export incidents');
        ...
        axios.post('http://localhost:8000/api/incidents/export/', {
          ...
          user_id: 'user123', // You might want to get this from your auth system
